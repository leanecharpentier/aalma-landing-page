...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let phoneNumber = '';
    if (phoneInputRef.current && phoneInputRef.current.value.trim() !== '') {
    ...
    try {
      ...
      setSubmitMessage({
        type: 'error',
        text: error.message || 'Une erreur est survenue lors de l\'envoi. Veuillez réessayer.',
      });
    } finally {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start">
            ...
            <label htmlFor="rgpd" className="text-sm text-gray-700">
              J'accepte de recevoir des communications marketing de la part d'Aalma (vous pouvez vous
          ...
          <p className="text-xs text-gray-500">
            Les données collectées via ce formulaire sont traitées conformément au RGPD. Pour plus
          ...
          <button
            ...
            className={`w-full bg-primary text-black px-8 py-3 rounded-lg hover:bg-primary-light transition font-medium ${
