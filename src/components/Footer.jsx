      ...
      <div className="grid md:grid-cols-4 gap-8 px-6 md:px-24 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">
            La plateforme SaaS qui rend la santé mentale mesurable et actionnable dans votre entreprise.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-400">
            <li>
              <a href="#accueil" onClick={(e) => scrollToSection(e, '#accueil')} className="hover:text-white transition">
                Accueil
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#ressources" onClick={(e) => scrollToSection(e, '#ressources')} className="hover:text-white transition">
                Ressources
              </a>
            </li>
            <li>
